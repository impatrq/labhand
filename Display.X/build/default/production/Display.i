...
PORTBbits.RB4 = 0;
PORTBbits.RB5 = 0;
_delay((unsigned long)((5500)*(8000000L/4000000.0)));
_delay((unsigned long)((5500)*(8000000L/4000000.0)));
_delay((unsigned long)((5500)*(8000000L/4000000.0)));
_delay((unsigned long)((5500)*(8000000L/4000000.0)));
_delay((unsigned long)((5500)*(8000000L/4000000.0)));
...
{
    PORTBbits.RB0 = 0; PORTBbits.RB1 = 0; PORTBbits.RB2 = 1; PORTBbits.RB3 = 1; PORTBbits.RB4 = 0;
    PORTBbits.RB5 = 0; PORTBbits.RB0 = 0; PORTBbits.RB1 = 0; PORTBbits.RB2 = 1; PORTBbits.RB3 = 1;
    PORTBbits.RB4 = 1; PORTBbits.RB5 = 0;
    _delay((unsigned long)((5)*(8000000L/4000000.0)));
    PORTBbits.RB0 = 0; PORTBbits.RB1 = 0; PORTBbits.RB2 = 1; PORTBbits.RB3 = 1; PORTBbits.RB4 = 0;
    PORTBbits.RB5 = 0;
    _delay((unsigned long)((5500)*(8000000L/4000000.0)));
}
PORTBbits.RB0 = 0; PORTBbits.RB1 = 0; PORTBbits.RB2 = 1; PORTBbits.RB3 = 0; PORTBbits.RB4 = 0; PORTBbits.RB5 = 0;
PORTBbits.RB0 = 0; PORTBbits.RB1 = 0; PORTBbits.RB2 = 1; PORTBbits.RB3 = 0; PORTBbits.RB4 = 1; PORTBbits.RB5 = 0;
_delay((unsigned long)((5)*(8000000L/4000000.0)));
PORTBbits.RB0 = 0; PORTBbits.RB1 = 0; PORTBbits.RB2 = 1; PORTBbits.RB3 = 0; PORTBbits.RB4 = 0; PORTBbits.RB5 = 0;
_delay((unsigned long)((5500)*(8000000L/4000000.0)));
...
void Lcd_Chr_CP(char data){
PORTBbits.RB4 = 0; PORTBbits.RB5 = 1;
PORTBbits.RB0 = (data & 0b10000000)>>7; PORTBbits.RB1 = (data & 0b01000000)>>6;
PORTBbits.RB2 = (data & 0b00100000)>>5; PORTBbits.RB3 = (data & 0b00010000)>>4;
_delay(10);
PORTBbits.RB4 = 1; _delay((unsigned long)((5)*(8000000L/4000000.0))); PORTBbits.RB4 = 0;
PORTBbits.RB0 = (data & 0b00001000)>>3; PORTBbits.RB1 = (data & 0b00000100)>>2;
PORTBbits.RB2 = (data & 0b00000010)>>1; PORTBbits.RB3 = (data & 0b00000001);
_delay(10);
PORTBbits.RB4 = 1; _delay((unsigned long)((5)*(8000000L/4000000.0))); PORTBbits.RB4 = 0;
_delay((unsigned long)((5)*(8000000L/4000000.0))); _delay((unsigned long)((5500)*(8000000L/4000000.0)));
}
...
void main (void){
    ...
    while (1) {
        ...
        tension = (value_adc * 5)/1023.0;
        sprintf (txt, "Tension %.2f    ",tension);
        Lcd_Out2(1,1,txt);
        PORTC = value_adc;
    }
}
